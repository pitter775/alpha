<div class="row mt-1">
   ...
   <div class="col-lg-4">
      ...
      <div class="input-group input-group-merge">
         ...
         <?php
         $use_dt_nascimento = null;
         if(isset($user->use_dt_nascimento)){
            $use_dt_nascimento = $user->use_dt_nascimento;
         }
         ?>
         <input id="use_dt_nascimento" type="text" class="form-control flatpickr-basic" value="@if($use_dt_nascimento ) {{date( 'd/m/Y' , strtotime($use_dt_nascimento )) }} @endif" name="use_dt_nascimento" />
      </div>
   </div>

...
<div class="content-wrapper" data-aos=fade-left data-aos-delay=0>
   ...
   <div class="row">
    <div class="col-md-2">
        <img src="{{ asset('paper') }}/img/lgo-g.png" alt="" class="img-fluid" style=" width: 100px">
    </div>
    <div class="col-md-10">
      <h4 style="margin-top: 20px">Criação da Matricula Escolar</h4>
      <p>Preencha todos os dados solicitado no formulário abaixo para enviar a inscrição da matrícula.</p>
    </div>
                        ...
                        <div class="tab-content">
                           ...
                           <div class="tab-pane fade " id="responsaveis" aria-labelledby="responsaveis-tab" role="tabpanel">
                              <form class="form-responsavel">
                                 @csrf
                                 <input type="hidden" value="{{$user->id ?? ''}}" name="id_geral" id="id_geral" />
                                 @include('pages.site.responsaveis')                     
                              </form>
                           </div>
                           ...
                           <div class="tab-pane fade " id="alimentares" aria-labelledby="alimentares-tab" role="tabpanel" >
                              <form class="form-alimentares">
                                 @csrf
                                 <input type="hidden" value="{{$user->id ?? ''}}" name="id_geral" id="id_geral" />
                                 @include('pages.site.alimentares')                     
                              </form>
                           </div>
...
<script src="../../../app-assets/js/scripts/pages/app-usuario-site-detalhe.js"></script> 

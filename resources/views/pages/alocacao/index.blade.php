...
@extends('layouts.app', [
    'elementActive' => 'alocacao'
])
@section('content')
<!-- Modal novo usuário-->
<div class="modal modal-slide-in new-alocacao-modal fade" id="modals-slide-in">
    <div class="modal-dialog">
        <form class="add-new-alocacao modal-content pt-0">
            @csrf 
            <input type="hidden" value="" name="id_geral" id="id_geral">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
            <div class="modal-header mb-1">
                <h5 class="modal-title" id="exampleModalLabel"><span class="ediadi">Adicionar</span> Alocação</h5>
            </div>
            <div class="modal-body flex-grow-1">
                <div class="form-group">
                    <label class="form-label" for="name">Nome</label>
                    <input type="text" class="form-control dt-full-name" id="name" placeholder="Nome da Alocação" name="name" aria-label="Nome da Alocação" aria-describedby="name2" />
                </div>
...
<div class="content-wrapper" data-aos=fade-left data-aos-delay=0>
    ...
    <div class="content-header row">
        <h4>Gerenciar Alocações</h4>
    </div>
    <div class="content-body">
        <section class="app-alocacao-list">

            <!-- list section start -->
            <div class="card" >
                <div class=" " style="width: 100%;">
                    <table class="alocacao-list-table table table-sm table-responsive-lg" >
